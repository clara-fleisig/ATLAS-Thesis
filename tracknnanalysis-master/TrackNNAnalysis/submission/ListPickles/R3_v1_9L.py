...
def getMaps():
    ...
    #folderInfo["LayerRegion"]    = "R3_9L"
    #folderInfo["HTTLayerHits"]      = "7"
    #folderToRun["Region_2p0_2p2_SingleP_9L_Nom"] = folderInfo
    #
    #folderInfo = {}
    #folderInfo["path"]              = "HitInfo/v1/user.sabidi.mc15_14TeV.900174.PG_singlemu_InvPtFlat1_etaFlat20_22_phiFlat03_05.r12410.v3_1_EXT0"
    #folderInfo["type"]              = "Pickle"
    ...
    #folderToRun["Region_2p0_2p2_SingleP_9L_Stubs"] = folderInfo
    #
    ...
    #folderToRun["Region_2p0_2p2_ttbar_9L_Nom"] = folderInfo
    #
    #folderInfo = {}
    #folderInfo["path"]              = "HitInfo/v1/user.sabidi.mc15_14TeV.600012.PhPy8EG_A14_ttbar_hdamp258p75_nonallhad.r12064.v3_EXT0"
    #folderInfo["type"]              = "Pickle"
    ...
    #folderInfo["lwrEtaLim"]         = "2.0"
    #folderInfo["uprEtaLim"]         = "2.2"
    #folderToRun["Region_2p0_2p2_ttbar_9L_Stubs"] = folderInfo

    ############## HTT True
    #folderInfo = {}
    #folderInfo["path"]              = "HTTData/region3-stub-9L-noetafilter-mu0/"
    #folderInfo["type"]              = "PickleHTT"
    #folderInfo["LayerRegion"]    = "R3"
    #folderToRun["Region_2p0_2p2_HTTTrue_9L_Stub"] = folderInfo
    ############## HTT Fake
    #folderInfo = {}
    #folderInfo["path"]              = "HTTData/may3+4/region3/9L/nominal/"
    #folderInfo["type"]              = "PickleHTT"
    #folderInfo["LayerRegion"]    = "R3"
    #folderToRun["Region_2p0_2p2_HTTFake_9L_Nom"] = folderInfo
    #
    #folderInfo = {}
    #folderInfo["path"]              = "HTTData/may3+4/region3/9L/stubs/"
    #folderInfo["type"]              = "PickleHTT"
    #folderInfo["LayerRegion"]    = "R3"
    #folderToRun["Region_2p0_2p2_HTTFake_9L_Stubs"] = folderInfo
    return folderToRun
