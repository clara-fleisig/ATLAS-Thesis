#ifndef _DATAREADERACTS_H
#define _DATAREADERACTS_H
...
// Base class 
class DataReaderACTS: public DataReader 
{
    public:
        DataReaderACTS(TString fileName, TString geoFileName): DataReader(fileName, geoFileName){ m_pileupOnly = false; m_lwrPtLim = 1; m_uprPtLim=100000; m_muonOnly = false; m_LayerRegion = "noCut", m_deltaROverlap = 0;};
        virtual ~DataReaderACTS() {};
    ...
    protected:
        ...
        float m_uprPtLim;
        float m_etaLim;
        const std::vector<int> m_barrelVolumes = {17, 24,29};
